...
const taskSchema = new mongoose.Schema({
  ...
  // How the task came to exist: 'manual' (someone created it) or 'system'
  // (auto-generated by a service, e.g. HR/vehicle compliance). Drives UI badges
  // and lets people tell a reminder apart from a hand-assigned task.
