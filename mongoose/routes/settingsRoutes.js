...
router.post('/user/account/verify-totp', authService.ensureAnyRole(), settings.verifyAndEnableTotp);
router.post('/user/account/disable-totp', authService.ensureAnyRole(), settings.disableTotp);
router.post('/user/account/change-password', authService.ensureAnyRole(), settings.validateChangePassword, settings.changePassword);
