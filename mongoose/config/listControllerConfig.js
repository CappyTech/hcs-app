...
module.exports = {
  ...
  customer: {
    ...
    fieldOrder: [
      ...
      'DisplayName', 'DefaultNominalCode', 'DefaultCustomerReference',
      'VATNumber', 'IsRegisteredInEC', 'IsRegisteredOutsideEC',
      'ReceivesWholesalePricing', 'ApplyWHT', 'Email', 'EmailTemplateNumber', 'FaxNumber', 'MobileNumber',
    ],
    labelOverrides: {
